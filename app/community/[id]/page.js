...
const Community = () => {
  ...
  if (!lawyer) {
    return (
      <div className="flex-1justify-center items-center min-h-screen">
        No lawyer found.
      </div>
    );
  }
  ...
  return (
    <div className="bg-white p-8 flex-1 rounded-lg shadow-md mt-5 max-w-md w-full">
      ...
      <div className="flex items-center mt-4">
        <h2 className="text-xl font-bold text-gray-800">{lawyer.lawyerName}</h2>
      ...
      <div className="flex flex-col md:flex-row justify-between text-gray-700 mt-2">
        <div className="flex items-center">
          ...
          <h3 className="ml-2">{lawyer.contactNo}</h3>
        </div>
        <br></br>
        ...
        <div className="flex items-center">
          ...
          >
            <path d="M22 19V7L12 3 2 7v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2z" />
      ...
      <div className="flex items-center mt-4 space-x-4">
        <div className="flex items-center">
          ...
          <svg
            ...
            stroke-linejoin="round"
          >
            <path d="M2 20h20v-2H2v2zm0-2v-2h8v2H2zm14 0h8v-2h-8v2zm0-4V8h2v8h-2zM4 8h8v8H4V8z" />
            <path d="M10 10h4v4h-4z" />
          </svg>
          <h3 className="ml-2">High Court, Colombo 12</h3>
        </div>
        <div>
          <button class="border rounded-md px-4 py-2">
            {lawyer.myCategory} Expertise
          </button>
        </div>
      </div>
