  ...
  return (
    ...
    <section className="bg-blue-600 py-10">
      <div className="text-center text-white">
        <h1 className="text-4xl font-bold mb-4">Find the Best Lawyers in the Community</h1>
        <p className="text-lg mb-8">Search and connect with experienced lawyers in various legal fields</p>
      ...
      <div className="p-6">
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center text-sm text-gray-600 mb-2">
            <span className="material-icons mr-2"></span> Age: {lawyer.age}
          </div>
          <div className="flex items-center text-sm text-gray-600 mb-2">
            <span className="material-icons mr-2"></span> Experience: {lawyer.experienceYears} years
          </div>

          <div className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full mb-4">
            {lawyer.experienceYears >= 10 ? "Veteran Lawyer" : "Rising Star"}
          </div>
