...
export default function addLawyer() {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append('prevExperiences', prevExperiences.join(', ')); // Join experiences into a single string
    formData.append('profilePic', profilePic);
    formData.append('contactNo', contactNo);

    // Example of sending form data to a backend API
    // Replace 'your-backend-api-url' with your actual backend endpoint
